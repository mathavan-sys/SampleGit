...
public class CountriesControllerTest {
	...
	public void setup() throws AuthzSecurityException {
		...
		when(authorizor.isAllowed(ArgumentMatchers.anyString(), ArgumentMatchers.anyString(),
		...
		country.setDependentRelationshipId("1");
	...
	public void countryControllerTest() throws Exception {
		mockMvc.perform(
				MockMvcRequestBuilders.get(APIMappingConstants.V2 + APIMappingConstants.COUNTRY_GEOPOLITICAL_ID, 1)
						.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
						.header(GenericConstants.SECURITY_TOKEN, MediaType.TEXT_PLAIN_VALUE))
				.andExpect(status().isOk()).andReturn();

		mockMvc.perform(
				MockMvcRequestBuilders.get(APIMappingConstants.V2 + APIMappingConstants.COUNTRY + "?geopoliticalId=1")
						.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
						.header(GenericConstants.SECURITY_TOKEN, MediaType.TEXT_PLAIN_VALUE))
				.andExpect(status().isOk()).andReturn();

		mockMvc.perform(
				MockMvcRequestBuilders.get(APIMappingConstants.V2 + APIMappingConstants.COUNTRY + "?countryCd=US")
						.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
						.header(GenericConstants.SECURITY_TOKEN, MediaType.TEXT_PLAIN_VALUE))
				.andExpect(status().isOk()).andReturn();

		mockMvc.perform(MockMvcRequestBuilders
				.get(APIMappingConstants.V2 + APIMappingConstants.COUNTRY
						+ "?countryCd=US&targetDate=2020-06-13&endDate=2020-06-20")
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
		...
		mockMvc.perform(MockMvcRequestBuilders
				.get(APIMappingConstants.V2 + APIMappingConstants.COUNTRY
						+ "?countryCd=US&targetDate=2021-06-13&endDate=2020-06-20")
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
				.header(GenericConstants.SECURITY_TOKEN, MediaType.TEXT_PLAIN_VALUE)).andExpect(status().isBadRequest())
				.andReturn();

		mockMvc.perform(MockMvcRequestBuilders
				.get(APIMappingConstants.V2 + APIMappingConstants.COUNTRY + "?countryShortName=USA&orgStandardCode=ISO")
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
				.header(GenericConstants.SECURITY_TOKEN, MediaType.TEXT_PLAIN_VALUE)).andExpect(status().isOk())
				.andReturn();
