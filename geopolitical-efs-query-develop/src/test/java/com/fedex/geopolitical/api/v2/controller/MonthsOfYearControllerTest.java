...
@ActiveProfiles("test")
public class MonthsOfYearControllerTest {
	...
	public void setup() throws AuthzSecurityException {
		...
		RefMonthOfYear refMonthOfYear = new RefMonthOfYear();
		refMonthOfYear.setMonthOfYearNumber(1);
		refMonthOfYear.setMonthOfYearShortName("Dec");
		refMonthOfYear.setCreatedByUserId("3766269");
		refMonthOfYear.setCreatedTmstp(CommonUtilityTest.getCurrentTimeStamp());
		refMonthOfYear.setLastUpdatedByUserId("3766269");
		refMonthOfYear.setLastUpdatedTmstp(CommonUtilityTest.getCurrentTimeStamp());
		repository.save(refMonthOfYear);
	...
	public void createUpdateDOW() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get(APIMappingConstants.V2+APIMappingConstants.RMOYS).contentType(MediaType.APPLICATION_JSON)
