...
@ActiveProfiles("test")
public class DaysOfWeekControllerTest {
	...
	public void setup() throws AuthzSecurityException {
		...
		RefDayOfWeek refDayOfWeek = new RefDayOfWeek();
		refDayOfWeek.setDayOfWeekNumber(1);
		refDayOfWeek.setDayOfWeekFullName("Monday");
		refDayOfWeek.setDayOfWeekShortName("Mon");
		refDayOfWeek.setCreatedByUserId("3766269");
		refDayOfWeek.setCreatedTmstp(CommonUtilityTest.getCurrentTimeStamp());
		refDayOfWeek.setLastUpdatedByUserId("3766269");
		refDayOfWeek.setLastUpdatedTmstp(CommonUtilityTest.getCurrentTimeStamp());
		repository.save(refDayOfWeek);
	...
	public void createUpdateDOW() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get(APIMappingConstants.V2+APIMappingConstants.REFERENCE_DAYS_WEEK).contentType(MediaType.APPLICATION_JSON)
